...
export default function EditHotel() {
  ...
  // Fetch hotel data and destinations
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch hotel data
        const hotelRes = await axios.get(`http://localhost:5000/api/hotels/${id}`);
        ...
        setHotelData({
          ...
          images: hotel.images || [],
          contact: hotel.contact || { phone: "", email: "", address: "" },
          reviews: hotel.reviews || [],
        });

        // Set existing image previews
        if (hotel.images && hotel.images.length > 0) {
          setImagePreviews(hotel.images.map(img => `http://localhost:5000${img}`));
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("existingImages", JSON.stringify(hotelData.images));
          ...
          <div className="col-lg-10">
            <div className="card border shadow-sm">
              <div className="card-body text-center py-5">
                ...
                <p className="mt-3 text-dark">Loading hotel data...</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    <h2 className="fw-bold text-dark mb-1">Edit Hotel</h2>
                    <p className="text-muted mb-0">Update hotel information</p>
                  </div>
                </div>
                <button 
            ...
            <div className="card-body p-4">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5 pb-4 border-bottom">
                  ...
                  <div className="mb-3">
                    <label className="form-label fw-medium text-dark">Add More Hotel Images</label>
                    <input 
                      type="file" 
                      multiple 
                    ...
                    <div className="form-text text-dark">
                      ...
                      Select additional images of the hotel
                    </div>
                  </div>
                ...
                <div className="mb-5 pb-4 border-bottom">
                  ...
                  {hotelData.amenities.length > 0 && (
                    <div className="mt-3">
                      <h6 className="text-dark mb-3">Current Amenities ({hotelData.amenities.length})</h6>
