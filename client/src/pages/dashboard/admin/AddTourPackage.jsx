...
function AddTourPackage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const res = await axios.post("http://localhost:5000/api/tour-packages", data, {
      ...
      console.error(err);
      alert("Failed to add package. Check console for errors.");
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  <div className="bg-primary rounded-circle p-3 me-3 border">
                    <FaMap className="text-white fs-4" />
                  </div>
                  <div>
                    <h2 className="fw-bold text-dark mb-1">Add New Tour Package</h2>
                    <p className="text-muted mb-0">Create an exciting tour package for travelers</p>
                  </div>
                </div>
                <button 
              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <div className="card-body">
                      <div className="row align-items-center">
                        <div className="col-md-6">
                          <label className="form-label fw-medium text-dark">Upload Package Image</label>
                          <input
                            type="file"
                            name="image"
                          ...
                          <div className="form-text text-dark">
                            ...
                            Choose a high-quality image that represents your tour package
                          </div>
                        </div>
                ...
                <div className="mb-5 pb-4 border-bottom">
                  ...
                  {form.highlights.length > 0 && (
                    <div className="mt-3">
                      <h6 className="text-dark mb-3">Package Highlights ({form.highlights.length})</h6>
                      <div className="card border">
                        <div className="card-body">
